          ...
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Muhammad Rafay</h3>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>
                  Expert in Surgical Procedures and Treatments.
                </p>
              </div>
            </div>
            <div className='mt-[50px] border-solid border-[#0066ff34]'>
              ...
              <button
                ...
                } py-2 px-5 mr-5 text-16 leading-7 text-headingColor font-semibold`}
              >
                Feedback
              </button>
            </div>
